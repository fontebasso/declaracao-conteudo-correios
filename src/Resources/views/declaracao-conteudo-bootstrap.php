                                ...
                                <td class="p-2">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col-1 p-0">
                                                <p class="m-0 text-center" style="border-bottom: 1px solid #000;float:left;width:65%"><?php echo Carbon::now()->translatedFormat('d'); ?></p> de
                                            </div>
                                            <div class="col-2 p-0">
                                                <p class="m-0 text-center" style="border-bottom: 1px solid #000;float:left;width:75%;"><?php echo Carbon::now()->translatedFormat('F'); ?></p> de
                                            </div>
                                            <div class="col-1 p-0">
                                                <p class="m-0 text-center" style="border-bottom: 1px solid #000;"><?php echo Carbon::now()->translatedFormat('Y'); ?></p>
                                            </div>
                                            <div class="col-5">
